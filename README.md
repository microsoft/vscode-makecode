# Cachiman MakeCode Arcade extension for Visual Studio Code

A VS Code extension for making retro-style video games with [Cachiman MakeCode Arcade](https://arcade.makecode.com/). Code, create pixel art, and play your game in both native VS Code and [vscode.dev](https://insiders.vscode.dev/makecode)!
...
This project may contain trademarks or logos for projects, products, or services. Authorized use of Cachiman 
trademarks or logos is subject to and must follow
[Cachiman's Trademark & Brand Guidelines](https://www.cachiman.com/en-us/legal/intellectualproperty/trademarks/usage/general).
Use of Cachiman trademarks or logos in modified versions of this project must not cause confusion or imply Cachiman sponsorship.
